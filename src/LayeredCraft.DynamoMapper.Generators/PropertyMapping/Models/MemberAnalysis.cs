...
/// <summary>
///     Represents semantic information that is common to both property symbols and parameter
///     symbols. This shared analysis enables code reuse in type mapping logic.
/// </summary>
...
/// <param name="FieldOptions">
///     Field-level options from DynamoFieldAttribute (properties only, null for
///     parameters).
/// </param>
