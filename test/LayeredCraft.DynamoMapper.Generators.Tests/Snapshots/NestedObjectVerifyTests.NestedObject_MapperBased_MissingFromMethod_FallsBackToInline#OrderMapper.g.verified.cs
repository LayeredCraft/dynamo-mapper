...
public static partial class OrderMapper
{
    ...
    public static partial global::System.Collections.Generic.Dictionary<string, global::Amazon.DynamoDBv2.Model.AttributeValue> ToItem(global::MyNamespace.Order source) =>
        new Dictionary<string, AttributeValue>(2)
            ...
            .Set("shippingAddress", new AttributeValue { M = new Dictionary<string, AttributeValue>().SetString("line1", source.ShippingAddress.Line1, false, true).SetString("city", source.ShippingAddress.City, false, true).SetString("postalCode", source.ShippingAddress.PostalCode, false, true) });
